...
const frontlines = [
  ...
  },
  {
    ...
    pattern1: "남은 시간 10분 이전에 노드 4개, 이후에 노드 3개 등장",
  },
  {
    title: "영광의 평원(쇄빙전)",
    ...
    pattern1: "큰 얼음 패턴 2개, 작은 얼음 패턴 4개, 특수 패턴 1개",
  },
  {
    ...
    pattern1:
      "중앙에 가까울 수록 + 시간이 경과할 수록 -> 높은 등급의 노드가 뜰 확률 증가",
    pattern2: "남은 시간 10분 이전에 노드 4개, 이후에 노드 3개 등장",
  },
];

class Frontline extends Component {
  render() {
    return (
